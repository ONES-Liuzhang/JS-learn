...
export function cloneVNode(vnode: any, deep: any) {
...
export function cloneVNodes(vnodes: any, deep: any) {
...
export function cloneElement(n: any, nodeProps: any = {}, deep: any = undefined) {
  let ele = n
  if (Array.isArray(n)) {
    ele = filterEmpty(n)[0]
  }
  ...
  if (typeof data.class === 'string' && data.class.trim() !== '') {
    data.class.split(' ').forEach((c: any) => {
      (cls as any)[c.trim()] = true
    })
