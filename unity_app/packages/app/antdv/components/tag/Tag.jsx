...
export default {
  ...
  methods: {
    ...
    getTagStyle() {
      ...
      return { backgroundColor: color && !isPresetColor ? color : undefined }
    },
  ...
  render() {
    ...
    const tag = (
      <div v-show={visible} {...{ on: omit(this.$listeners, ['close']) }} class={this.getTagClassName(prefixCls)} style={this.getTagStyle()}>
        {this.$slots.default}
