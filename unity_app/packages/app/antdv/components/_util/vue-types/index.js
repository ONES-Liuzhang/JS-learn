...
const VuePropTypes = {
  get any() {
    return toType('any', { type: null })
  },

  get func() {
    return toType('function', { type: Function }).def(currentDefaults.func)
  },

  get bool() {
    return toType('boolean', { type: Boolean }).def(currentDefaults.bool)
  },

  get string() {
    return toType('string', { type: String }).def(currentDefaults.string)
  },

  get number() {
    return toType('number', { type: Number }).def(currentDefaults.number)
  },

  get array() {
    return toType('array', { type: Array }).def(currentDefaults.array)
  },

  get object() {
    return toType('object', { type: Object }).def(currentDefaults.object)
  },
  ...
  instanceOf(instanceConstructor) {
    return toType('instanceOf', { type: instanceConstructor })
  },
  ...
  oneOfType(arr) {
    ...
    if (!hasCustomValidators) {
      ...
      return toType('oneOfType', { type: nativeChecks }).def(undefined)
    }
