...
export default {
  ...
  render() {
    const { prefixCls: customizePrefixCls, items = [], listType, showPreviewIcon, showRemoveIcon, locale } = getOptionProps(this)
    ...
    const list = items.map((file) => {
      ...
      const preview = file.url ? (
        ...
        <span class={`${prefixCls}-list-item-name`} onClick={(e) => this.handlePreview(file, e)} title={file.name}>
          {file.name}
        </span>
      )
      const style =
