...
export default {
  ...
  methods: {
    ...
    autoUpdateProgress(_, file) {
      ...
      this.progressTimer = setInterval(() => {
        ...
        this.onProgress({ percent: curPercent * 100 }, file)
      }, 200)
    },
    ...
    renderUploadList(locale) {
      ...
      const uploadListProps = {
        ...
        on: { remove: this.handleManualRemove }
      }
  ...
  render() {
    ...
    const uploadList = showUploadList ? (
      <LocaleReceiver componentName="Upload" defaultLocale={defaultLocale.Upload} scopedSlots={{ default: this.renderUploadList }} />
    ) : null
    ...
    if (type === 'drag') {
      ...
      return (
        <span>
          <div class={dragCls} onDrop={this.onFileDrop} onDragover={this.onFileDrop} onDragleave={this.onFileDrop}>
