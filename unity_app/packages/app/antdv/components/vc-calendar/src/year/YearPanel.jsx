...
export default {
  ...
  data() {
    ...
    return { sValue: this.value || this.defaultValue }
  },
  methods: {
    years() {
  ...
  render() {
    ...
    const yeasEls = years.map((row, index) => {
      const tds = row.map((yearData) => {
        ...
        return (
          <td role="gridcell" title={yearData.title} key={yearData.content} onClick={clickHandler} class={classNameMap}>
      ...
      <div class={prefixCls}>
        <div>
          <div class={`${prefixCls}-header`}>
            <a class={`${prefixCls}-prev-decade-btn`} role="button" onClick={this.previousDecade} title={locale.previousDecade} />
            <a class={`${prefixCls}-decade-select`} role="button" onClick={decadePanelShow} title={locale.decadeSelect}>
            ...
            <a class={`${prefixCls}-next-decade-btn`} role="button" onClick={this.nextDecade} title={locale.nextDecade} />
          </div>
