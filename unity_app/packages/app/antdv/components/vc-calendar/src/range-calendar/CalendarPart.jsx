...
const CalendarPart = {
  ...
  render() {
    ...
    const { inputChange = noop, inputSelect = noop, valueChange = noop, panelChange = noop, select = noop, dayHover = noop } = $listeners
    const shouldShowTimePicker = showTimePicker && timePicker
    const disabledTimeConfig = shouldShowTimePicker && disabledTime ? getTimeConfig(selectedValue, disabledTime) : null
