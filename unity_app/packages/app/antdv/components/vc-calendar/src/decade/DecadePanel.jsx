    ...
    return (
      <div class={prefixCls}>
        <div class={`${prefixCls}-header`}>
          <a class={`${prefixCls}-prev-century-btn`} role="button" onClick={this.previousCentury} title={locale.previousCentury} />

          <div class={`${prefixCls}-century`}>
            {startYear}-{endYear}
          </div>
          <a class={`${prefixCls}-next-century-btn`} role="button" onClick={this.nextCentury} title={locale.nextCentury} />
        </div>
