...
export default {
  ...
  render() {
    const { panels: children, activeKey, prefixCls, tabBarGutter, saveRef, tabBarPosition } = this.$props
    const rst = []
    ...
    children.forEach((child, index) => {
      ...
      const style = { [isVertical(tabBarPosition) ? 'marginBottom' : 'marginRight']: gutter }
