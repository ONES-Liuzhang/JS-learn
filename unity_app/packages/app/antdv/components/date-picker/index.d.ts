...
import { DatepickerCommon } from './types/common';
import { Moment } from 'moment';
import { RangePicker } from './types/range-picker';
import { MonthPicker } from './types/month-picker';
import { WeekPicker } from './types/week-picker';

export default class DatePicker extends DatepickerCommon {
