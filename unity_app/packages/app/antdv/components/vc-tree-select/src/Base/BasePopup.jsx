...
function getDerivedStateFromProps(nextProps, prevState) {
  const { _prevProps: prevProps = {}, _loadedKeys: loadedKeys, _expandedKeyList: expandedKeyList, _cachedExpandedKeyList: cachedExpandedKeyList } =
    prevState || {}
  const { valueList, valueEntities, keyEntities, treeExpandedKeys, filteredTreeNodes, upperSearchValue } = nextProps

  const newState = { _prevProps: { ...nextProps } }
...
const BasePopup = {
  ...
  render() {
    ...
    const {vcTreeSelect: { onPopupKeyDown, onTreeNodeSelect, onTreeNodeCheck }} = this
