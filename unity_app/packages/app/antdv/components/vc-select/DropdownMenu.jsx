...
export default {
  ...
  methods: {
    scrollActiveItemToView() {
      ...
      const scrollIntoViewOpts = { onlyScrollIfNeeded: true }
    ...
    renderMenu() {
      const props = this.$props
      const { menuItems, defaultActiveFirstOption, value, prefixCls, multiple, inputValue, firstActiveValue, dropdownMenuStyle, backfillValue, visible } = props
