...
export default {
  ...
  methods: {
    ...
    getDropdownElement(newProps) {
      const { value, firstActiveValue, defaultActiveFirstOption, dropdownMenuStyle, getDropdownPrefixCls, backfillValue, menuItemSelectedIcon } = this
  ...
  render() {
    ...
    const triggerProps = {
      ...
      on: { popupVisibleChange: dropdownVisibleChange },
      directives: [
        {
          name: 'ant-ref',
