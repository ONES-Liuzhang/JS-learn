...
export default {
    ...
    getIconsProps(prefixCls) {
      ...
      const jumpPrevIcon = (
        <a class={`${prefixCls}-item-link`}>
          ...
          <div class={`${prefixCls}-item-container`}>
            <Icon class={`${prefixCls}-item-link-icon`} type="dLeft" />
      ...
      const jumpNextIcon = (
        <a class={`${prefixCls}-item-link`}>
          {/* You can use transition effects in the container :) */}
          <div class={`${prefixCls}-item-container`}>
            <Icon class={`${prefixCls}-item-link-icon`} type="dRight" />
            <span class={`${prefixCls}-item-ellipsis`}>•••</span>
          </div>
        </a>
      )
  ...
  render() {
    return <LocaleReceiver componentName="Pagination" defaultLocale={enUS} scopedSlots={{ default: this.renderPagination }} />
  }
}
