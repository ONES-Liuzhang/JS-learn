  ...
  methods: {
    renderSwitcherIcon(prefixCls, switcherIcon, { isLeaf, expanded, loading }) {
      ...
      if (showLine) {
        ...
        return <Icon type={expanded ? 'minus-square' : 'plus-square'} class={`${prefixCls}-switcher-line-icon`} theme="outlined" />
      }
      ...
      if (isLeaf) {
        ...
        return cloneElement(switcherIcon, { class: { [switcherCls]: true } })
      }
