...
const Slider = {
  ...
  props: {
    ...SliderProps(),
    tipFormatter: PropTypes.oneOfType([PropTypes.func, PropTypes.object]).def((value) => value.toString())
  },
  data() {
    return { visibles: {} }
  },
  ...
  render() {
    const { range, prefixCls: customizePrefixCls, tooltipPrefixCls: customizeTooltipPrefixCls, ...restProps } = getOptionProps(this)
