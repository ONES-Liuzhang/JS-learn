...
export default {
  ...
  render(createElement, context) {
    ...
    const { slideCount, slidesToScroll, slidesToShow, infinite, currentSlide, appendDots, customPaging, clickHandler, dotsClass } = props
    ...
    const dots = Array.apply(
      ...
      const className = classnames({ 'slick-active': currentSlide >= leftBound && currentSlide <= rightBound })
