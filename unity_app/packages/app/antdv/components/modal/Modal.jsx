...
export default {
  ...
  methods: {
    ...
    renderFooter(locale) {
      ...
      return (
        <div>
          <Button {...cancelBtnProps}>{getComponentFromProp(this, 'cancelText') || locale.cancelText}</Button>
  ...
  render() {
    const { prefixCls: customizePrefixCls, visible, wrapClassName, centered, $listeners, $slots } = this

    const { getPrefixCls } = this.configProvider
    const prefixCls = getPrefixCls('modal', customizePrefixCls)

    const defaultFooter = <LocaleReceiver componentName="Modal" defaultLocale={getConfirmLocale()} scopedSlots={{ default: this.renderFooter }} />
    const closeIcon = (
