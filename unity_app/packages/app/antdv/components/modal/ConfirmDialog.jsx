...
export default {
  ...
  render(h, context) {
    ...
    const icon = props.icon ? props.icon : type
    ...
    const classString = classNames(contentPrefixCls, `${contentPrefixCls}-${type}`, `${prefixCls}-${props.type}`, props.class)
    ...
    const iconNode = typeof icon === 'string' ? <Icon type={icon} class={`${contentPrefixCls}-${icon}`} /> : icon(h)
      ...
      >
        <div class={`${contentPrefixCls}-body-wrapper`}>
          <div class={`${contentPrefixCls}-body`}>
            {iconNode}
            <span class={`${contentPrefixCls}-title`}>{typeof props.title === 'function' ? props.title(h) : props.title}</span>
            <div class={`${contentPrefixCls}-content`}>{typeof props.content === 'function' ? props.content(h) : props.content}</div>
          </div>
