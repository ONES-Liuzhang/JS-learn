...
export default {
  ...
  render() {
    const { stateValue, handleKeyDown, handleTextareaChange, textareaStyles, $attrs, $listeners, prefixCls: customizePrefixCls, disabled } = this
    const otherProps = omit(this.$props, ['prefixCls', 'autosize', 'type', 'value', 'defaultValue', 'lazy'])
    const { getPrefixCls } = this.configProvider
    const prefixCls = getPrefixCls('input', customizePrefixCls)

    const cls = classNames(prefixCls, { [`${prefixCls}-disabled`]: disabled })
    ...
    return <textarea {...textareaProps} value={stateValue} class={cls} style={textareaStyles} ref="textArea" />
  },
}
