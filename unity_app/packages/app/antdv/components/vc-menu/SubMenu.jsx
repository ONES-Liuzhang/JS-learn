...
const SubMenu = {
  ...
  render() {
    ...
    if (!props.disabled) {
      ...
      titleClickEvents = { click: this.onTitleClick }
      titleMouseEvents = {
    ...
    if (isOpen) {
      ariaOwns = { 'aria-owns': this._menuId }
    }
    const titleProps = {
      attrs: {
    ...
    const getPopupContainer = this.parentMenu.isRootMenu ? this.parentMenu.getPopupContainer : (triggerNode) => triggerNode.parentNode
