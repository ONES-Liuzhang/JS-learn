...
export default {
  ...
  render() {
    ...
    const { columns, fixed, tableClassName, getRowKey, handleBodyScroll, handleWheel, expander, isAnyColumnsFixed } = this
    ...
    if (fixed && columns.length) {
      ...
      return (
        <div key="bodyTable" class={`${prefixCls}-body-outer`} style={{ ...bodyStyle }}>
          <div class={`${prefixCls}-body-inner`} style={innerBodyStyle} ref={refName} onWheel={handleWheel} onScroll={handleBodyScroll}>
            {baseTable}
          </div>
        </div>
      )
    ...
    return (
      <div key="bodyTable" class={`${prefixCls}-body`} style={bodyStyle} ref="bodyTable" onWheel={handleWheel} onScroll={handleBodyScroll}>
        {baseTable}
      </div>
    )
  },
