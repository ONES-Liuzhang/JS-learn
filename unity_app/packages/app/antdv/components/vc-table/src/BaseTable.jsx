  ...
  methods: {
    getColumns(cols) {
      ...
      return (cols || columns).map((column) => ({
        ...column,
        className:
          !!column.fixed && !fixed ? classNames(`${prefixCls}-fixed-columns-in-body`, column.className || column.class) : column.className || column.class,
      }))
    },
    handleRowHover(isHover, key) {
      this.store.setState({ currentHoverKey: isHover ? key : null })
    },
