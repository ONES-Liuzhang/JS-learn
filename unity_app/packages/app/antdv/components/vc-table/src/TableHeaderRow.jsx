      ...
      <HeaderRow {...rowProps} style={style}>
        {row.map((cell, i) => {
          ...
          if (column.align) {
            ...
            headerCellProps.class = classNames(customProps.cls, column.class, column.className, { [`${prefixCls}-align-${column.align}`]: !!column.align })
          }
...
export default connect((state, props) => {
  return { height: getRowHeight(state, props) }
})(TableHeaderRow)
