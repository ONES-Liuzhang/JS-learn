...
export default {
  ...
  render() {
    ...
    return (
      <div key="headTable" ref={fixed ? null : 'headTable'} class={`${prefixCls}-header`} style={headStyle} onScroll={handleBodyScrollLeft}>
        <BaseTable tableClassName={tableClassName} hasHead hasBody={false} fixed={fixed} columns={columns} expander={expander} />
      </div>
    )
  }
}
