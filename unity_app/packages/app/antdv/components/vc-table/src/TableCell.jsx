...
export default {
  ...
  render() {
    const { record, indentSize, prefixCls, indent, index, expandIcon, column, component: BodyCell } = this
    ...
    const indentText = expandIcon ? <span style={{ paddingLeft: `${indentSize * indent}px` }} class={`${prefixCls}-indent indent-level-${indent}`} /> : null
