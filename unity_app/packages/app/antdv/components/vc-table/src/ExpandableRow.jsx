...
const ExpandableRow = {
  ...
  render() {
    const { childrenColumnName, expandedRowRender, indentSize, record, fixed, $scopedSlots, expanded } = this
    ...
    const expandableRowProps = {
      ...
      on: { rowClick: this.handleRowClick },
    }
...
export default connect(({ expandedRowKeys }, { rowKey }) => ({ expanded: !!~expandedRowKeys.indexOf(rowKey) }))(ExpandableRow)
