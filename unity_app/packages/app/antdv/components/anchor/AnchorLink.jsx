...
export default {
  ...
  render() {
    ...
    const wrapperClassName = classNames(`${prefixCls}-link`, { [`${prefixCls}-link-active`]: active })
    const titleClassName = classNames(`${prefixCls}-link-title`, { [`${prefixCls}-link-title-active`]: active })
    return (
      <div class={wrapperClassName}>
        <a class={titleClassName} href={href} title={typeof title === 'string' ? title : ''} onClick={this.handleClick}>
          {title}
        </a>
        {$slots.default}
      </div>
