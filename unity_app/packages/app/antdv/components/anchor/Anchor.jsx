...
export default {
  ...
  methods: {
    handleScroll() {
      ...
      this.setState({ activeLink: this.getCurrentAnchor(offsetTop, bounds) })
    },
  ...
  render() {
    ...
    const inkClass = classNames(`${prefixCls}-ink-ball`, { visible: activeLink })

    const wrapperClass = classNames(this.wrapperClass, `${prefixCls}-wrapper`)

    const anchorClass = classNames(prefixCls, { fixed: !affix && !showInkInFixed })
