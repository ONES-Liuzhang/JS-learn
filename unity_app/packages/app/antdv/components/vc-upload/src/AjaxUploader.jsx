...
const AjaxUploader = {
  ...
  methods: {
    ...
    onFileDrop(e) {
      ...
      if (this.directory) {
        traverseFileTree(e.dataTransfer.items, this.uploadFiles, (_file) => attrAccept(_file, this.accept))
      } else {
        const files = partition(Array.prototype.slice.call(e.dataTransfer.files), (file) => attrAccept(file, this.accept))
  ...
  render() {
    ...
    const { componentTag: Tag, prefixCls, disabled, multiple, accept, directory, openFileDialogOnClick } = $props
