...
export default {
  ...
  methods: {
    renderExpandIcon(panelProps, prefixCls) {
      ...
      return isValidElement(Array.isArray(expandIcon) ? icon[0] : icon) ? cloneElement(icon, { class: `${prefixCls}-arrow` }) : icon
    }
  },
  render() {
    ...
    const collapseClassName = { [`${prefixCls}-borderless`]: !bordered }
