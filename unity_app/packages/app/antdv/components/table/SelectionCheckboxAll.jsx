...
export default {
    ...
    getCheckState(props) {
      ...
      if (!data.length) {
        ...
        checked = store.getState().selectionDirty ?
          ...
          this.checkSelection(props, data, 'every', false) || this.checkSelection(props, data, 'every', true)
      }
      return checked
    },
    ...
    getIndeterminateState(props) {
      ...
      if (!data.length) {
        ...
        indeterminate = store.getState().selectionDirty ?
          this.checkSelection(props, data, 'some', false) && !this.checkSelection(props, data, 'every', false) :
          (this.checkSelection(props, data, 'some', false) && !this.checkSelection(props, data, 'every', false)) ||
            (this.checkSelection(props, data, 'some', true) && !this.checkSelection(props, data, 'every', true))
      }
  ...
  render() {
    ...
    if (selections) {
      const newSelections = Array.isArray(selections) ? this.defaultSelections.concat(selections) : this.defaultSelections
