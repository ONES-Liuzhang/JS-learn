...
const TreeSelect = {
  ...
  render(h) {
    ...
    const { prefixCls: customizePrefixCls, size, dropdownStyle, dropdownClassName, getPopupContainer, ...restProps } = props
    ...
    const inputIcon = (suffixIcon && (isValidElement(suffixIcon) ? cloneElement(suffixIcon) : suffixIcon)) || (
