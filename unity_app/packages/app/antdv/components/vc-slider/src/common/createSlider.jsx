...
export default function createSlider(Component) {
  ...
  return {
    ...
    render(h) {
      const { prefixCls, marks, dots, step, included, disabled, vertical, min, max, maximumTrackStyle, railStyle, dotStyle, activeDotStyle } = this
      ...
      const markProps = {
        ...
        on: {clickLabel: disabled ? noop : this.onClickMarkLabel}
      }
      return (
        <div
          ref="sliderRef"
